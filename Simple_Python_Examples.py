...
yil_sonu = {}
for i in range(4):
    ders = input("Lutfen ders adini giriniz:")
    vize = int(input("Lutfen vize notunuzu giriniz:"))
    final = int(input("Lutfen final notunuzu giriniz:"))
    sonuc = (vize * 0.4) + (final * 0.6)
    
    if sonuc >= 50:
        yil_sonu[ders]="Basarili"
    
    else:
        yil_sonu[ders]="Basariz"

for i,j in yil_sonu.items():
    print("{} dersinden yil sonu durmunuz {}`dir.".format(i,j))
